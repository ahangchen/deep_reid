...
parser.add_argument('--test_dir',default='/home/cwh/coding/dataset/market/pytorch',type=str, help='./test_data')
parser.add_argument('--name', default='grid', type=str, help='save model path')
parser.add_argument('--class_cnt', default=250, type=int, help='class count in training set')
...
for i in range(len(train_label)):
    index, score = sort_by_score(train_feature[i],train_feature)
    scores.append(score)
    indexs.append(index)
...
score_path = os.path.join('eval', transfer_name, 'score.txt')
pid_path = os.path.join('eval', transfer_name, 'pid.txt')
